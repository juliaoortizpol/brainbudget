...
@Injectable()
export class TransactionMailImportPipelineService {
  constructor(
  ...
  async run(userId: string, options: TransactionMailImportOptionsDto) {
    ...
    return { context, mailQuery, fetched, parsing, matching };
  }
}
